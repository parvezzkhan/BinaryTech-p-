      ...
      >
        <div className="container">
          ...
          <div className="py-8">
            ...
            All Rights Reserved © <span className="font-bold">BinaryTech</span>{" "}
              <span rel="nofollow noopener">
              | Designed by <a className="text-blue-600 font-bold underline" rel="noopener noreferrer" target="_blank" href="https://in.linkedin.com/in/mehmedx7">Mohammed</a>
              </span>
            </p>
          </div>
        </div>
